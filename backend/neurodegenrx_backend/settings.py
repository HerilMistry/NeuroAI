"""
Django settings for neurodegenrx_backend project.
"""
import os
...
ROOT_URLCONF = 'neurodegenrx_backend.urls'
...
WSGI_APPLICATION = 'neurodegenrx_backend.wsgi.application'
...
# Django 5+ storage configuration (replaces deprecated STATICFILES_STORAGE)
STORAGES = {
    'default': {
...
# Also allow all origins in DEBUG mode for easier development
if DEBUG:
...
# Data files directory (gitignored)
